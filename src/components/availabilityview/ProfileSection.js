...
const ProfileSection = ({
    ...
    <div className="cal-bg-white/10 cal-backdrop-blur-xl cal-p-6 cal-text-gray-800 
            cal-flex cal-flex-col cal-h-full cal-border-r- cal-border-l-0 cal-border-t-0 cal-border-b-0 cal-border-white cal-border-solid  ">
        {/* Logo */}
        ...
        {/* Duration */}
        <div className="cal-flex cal-items-center cal-gap-2 cal-text-sm cal-text-gray-600 cal-mb-4 cal-font-semibold">
            <Clock size={16} />
        ...
        <div className="cal-mt-auto cal-pb-2">
            ...
            className="cal-flex cal-items-center cal-my-10 cal-justify-center cal-gap-1 cal-w-30 cal-py-2 cal-bg-white/40 cal-backdrop-blur-sm cal-rounded-xl cal-text-gray-800 hover:cal-text-gray-900 hover:cal-bg-white/60 cal-transition-all cal-font-semibold cal-text-sm cal-shadow-lg cal-border cal-border-white/30">
                <Copy size={14} />
                Copy Link
            </button>
        </div>
